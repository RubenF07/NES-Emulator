...
pub static ref OPS_CODE_MAP: HashMap<u8, OpCode> = {
    ...
    m.insert(0x0a, OpCode::new(0x0a, "ASL", 1, AddressingMode::NoneAddresssing)); //Accumulator
    ...
    m.insert(0x90, OpCode::new(0x90, "BCC", 2, AddressingMode::NoneAddresssing));
    
    m.insert(0xb0, OpCode::new(0xb0, "BCS", 2, AddressingMode::NoneAddresssing));
    
    m.insert(0xf0, OpCode::new(0xf0, "BEQ", 2, AddressingMode::NoneAddresssing));
    
    m.insert(0x24, OpCode::new(0x24, "BIT", 2, AddressingMode::ZeroPage));
    m.insert(0x2c, OpCode::new(0x2c, "BIT", 3, AddressingMode::Absolute));
    
    m.insert(0x30, OpCode::new(0x30, "BMI", 2, AddressingMode::NoneAddresssing));
    
    m.insert(0xd0, OpCode::new(0xd0, "BNE", 2, AddressingMode::NoneAddresssing));
    
    m.insert(0x10, OpCode::new(0x10, "BPL", 2, AddressingMode::NoneAddresssing));
    
    m.insert(0x00, OpCode::new(0x00, "BRK", 1, AddressingMode::NoneAddresssing));
    
    m.insert(0x50, OpCode::new(0x50, "BVC", 2, AddressingMode::NoneAddresssing));
    
    m.insert(0x70, OpCode::new(0x70, "BVS", 2, AddressingMode::NoneAddresssing));
    
    m.insert(0x18, OpCode::new(0x18, "CLC", 1, AddressingMode::NoneAddresssing));

    // CLD - skipped
    
    m.insert(0x58, OpCode::new(0x58, "CLI", 1, AddressingMode::NoneAddresssing));
    
    m.insert(0xb8, OpCode::new(0xb8, "CLV", 1, AddressingMode::NoneAddresssing));
    ...
    m.insert(0xca, OpCode::new(0xca, "DEX", 1, AddressingMode::NoneAddresssing));
    
    m.insert(0x88, OpCode::new(0x88, "DEY", 1, AddressingMode::NoneAddresssing));
    ...
    m.insert(0xc8, OpCode::new(0xc8, "INY", 1, AddressingMode::NoneAddresssing));
    
    m.insert(0x4c, OpCode::new(0x4c, "JMP", 3, AddressingMode::Absolute));
    m.insert(0x6c, OpCode::new(0x6c, "JMP", 3, AddressingMode::NoneAddresssing)); //Indirect
    ...
    m.insert(0x4a, OpCode::new(0x4a, "LSR", 1, AddressingMode::NoneAddresssing)); //Accumulator
    ...
    m.insert(0xea, OpCode::new(0xea, "NOP", 1, AddressingMode::NoneAddresssing));
    ...
    m.insert(0x48, OpCode::new(0x48, "PHA", 1, AddressingMode::NoneAddresssing));
    
    m.insert(0x08, OpCode::new(0x08, "PHP", 1, AddressingMode::NoneAddresssing));
    
    m.insert(0x68, OpCode::new(0x68, "PLA", 1, AddressingMode::NoneAddresssing));

    m.insert(0x28, OpCode::new(0x28, "PLP", 1, AddressingMode::NoneAddresssing));

    m.insert(0x2a, OpCode::new(0x2a, "ROL", 1, AddressingMode::NoneAddresssing)); // Accumulator
    ...
    m.insert(0x6a, OpCode::new(0x6a, "ROR", 1, AddressingMode::NoneAddresssing)); // Accumulator
    ...
    m.insert(0x38, OpCode::new(0x38, "SEC", 1, AddressingMode::NoneAddresssing));

    // SED - skipped

    m.insert(0x78, OpCode::new(0x78, "SEI", 1, AddressingMode::NoneAddresssing));
    ...
    m.insert(0xa8, OpCode::new(0xa8, "TAY", 1, AddressingMode::NoneAddresssing));    

    m.insert(0xba, OpCode::new(0xba, "TSX", 1, AddressingMode::NoneAddresssing));
    
    m.insert(0x8a, OpCode::new(0x8a, "TXA", 1, AddressingMode::NoneAddresssing));
    
    m.insert(0x9a, OpCode::new(0x9a, "TXS", 1, AddressingMode::NoneAddresssing));

    m.insert(0x98, OpCode::new(0x98, "TYA", 1, AddressingMode::NoneAddresssing));
